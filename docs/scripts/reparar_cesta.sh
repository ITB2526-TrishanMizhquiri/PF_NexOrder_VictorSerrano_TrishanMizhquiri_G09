#!/bin/bash
# =========================================================
# SCRIPT DE REPARACIÓN - Cesta/Carrito no visible
# =========================================================
...
echo -e "${GREEN}🔧 Reparando visibilidad de la cesta...${NC}"
echo "=============================================="

# =========================================================
# PASO 1: Verificar si hay sesión activa
# =========================================================
echo -e "${YELLOW}[1/4] Verificando configuración de sesión...${NC}"

# Crear archivo de test de sesión
sudo tee /var/www/nexorder/public/test_sesion.php > /dev/null <<'EOF'
<?php
...
sudo chown apache:apache /var/www/nexorder/public/test_sesion.php
sudo chmod 644 /var/www/nexorder/public/test_sesion.php

echo "✅ Archivo de test creado: https://44.207.176.14/test_sesion.php"

# =========================================================
# PASO 2: Actualizar menu.php para mostrar cesta visible
# =========================================================
echo -e "${YELLOW}[2/4] Actualizando menu.php con cesta visible...${NC}"

sudo tee /var/www/nexorder/public/menu.php > /dev/null <<'EOFPHP'
<?php
...
echo "✅ menu.php actualizado con cesta siempre visible"
...
sudo chown apache:apache /var/www/nexorder/public/menu.php
sudo chmod 644 /var/www/nexorder/public/menu.php
sudo restorecon -v /var/www/nexorder/public/menu.php 2>/dev/null || true
sudo chcon -t httpd_sys_content_t /var/www/nexorder/public/menu.php 2>/dev/null || true
...
echo ""
echo "🔗 Prueba ahora:"
echo "   https://44.207.176.14/menu.php"
echo ""
echo "📋 La cesta ahora es SIEMPRE VISIBLE en la parte superior"
echo "   - Muestra productos añadidos"
echo "   - Muestra total"
echo "   - Permite eliminar productos"
echo "   - Permite vaciar cesta"
echo ""
echo "🧪 Para diagnosticar:"
echo "   https://44.207.176.14/test_sesion.php"
