#!/bin/bash
# =========================================================
# SCRIPT DE REPARACIÓN DEFINITIVA - admin.php, cocina.php, pedido.php
# Reescribe los 3 archivos con código limpio y columnas correctas
# =========================================================
...
echo -e "${GREEN}🔧 REPARACIÓN DEFINITIVA - 3 archivos${NC}"
echo "============================================="

# =========================================================
# PASO 1: Detectar estructura real de tabla estados
# =========================================================
echo -e "${YELLOW}[1/5] Detectando estructura de tabla estados...${NC}"

ESTRUCTURA=$(mysql -h nexorder-db.cijbieo4judf.us-east-1.rds.amazonaws.com \
             -u nexorder_app -p'N3x0r-DB-2026!Sec' \
             nexorder_db -e "DESCRIBE estados;" 2>/dev/null)

echo "$ESTRUCTURA"

# Detectar columna de nombre del estado
COL_NOMBRE=""
for col in "nombre_estado" "nombre" "estado" "descripcion" "label"; do
    if echo "$ESTRUCTURA" | grep -qi "$col"; then
        COL_NOMBRE="$col"
        break
    fi
done
...
COL_ID=""
for col in "id_estado" "id" "estado_id"; do
    if echo "$ESTRUCTURA" | grep -qi "$col"; then
        COL_ID="$col"
        break
    fi
...
echo "✅ Columna ID detectada: $COL_ID"

# =========================================================
# PASO 2: Reescribir admin.php
# =========================================================
echo -e "${YELLOW}[2/5] Reescribiendo admin.php...${NC}"
...
# =========================================================
# PASO 3: Reescribir cocina.php
# =========================================================
echo -e "${YELLOW}[3/5] Reescribiendo cocina.php...${NC}"
...
# =========================================================
# PASO 4: Reescribir pedido.php
# =========================================================
echo -e "${YELLOW}[4/5] Reescribiendo pedido.php...${NC}"
...
# =========================================================
# PASO 5: Permisos y reinicio
# =========================================================
echo -e "${YELLOW}[5/5] Configurando permisos y reiniciando...${NC}"
...
echo "   - ID estado: $COL_ID"
echo "   - Nombre estado: $COL_NOMBRE"
echo ""
echo "🔗 Prueba ahora:"
