...
**Versión del documento:** 1.0 (Público)

> ℹ️ **Propósito:** Documento informativo para clientes y partes interesadas. Para detalles técnicos, consultar la documentación interna enlazada al final.
...
| ☁️ Backups replicados en otra región | Mayor resiliencia ante fallos regionales | Sprint 4 |
| 🛡️ Protección WAF básica | Bloqueo proactivo de ataques web comunes | Sprint 4 |
| 📊 Métricas de negocio en dashboard | Visibilidad de pedidos, ingresos, tendencias | Sprint 4 |

---

## ℹ️ Información Legal y Contacto
...
> ℹ️ **Nota:** Este documento es informativo y no constituye un contrato de nivel de servicio (SLA). Para acuerdos formales de disponibilidad y soporte, consultar el contrato específico firmado con NexOrder.